    ...
    local function install_ts_cli()
      ...
      if os_name == 'Linux' then
        ...
        elseif check_cmd 'npm' then
          ...
          vim.notify(
            'No package manager found. Please install tree-sitter-cli manually.',
      ...
      elseif os_name == 'Darwin' then
        if check_cmd 'brew' then
          ...
          vim.notify(
            'Homebrew not found. Please install tree-sitter-cli manually.',
            vim.log.levels.ERROR
          )
          return
        end
        ...
        vim.notify(
          'Unsupported OS: '
            .. os_name
            .. '. Please install tree-sitter-cli manually.',
          vim.log.levels.ERROR
        )
        return
      end
